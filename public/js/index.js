  ...
  const e = [
      {
        ...
        emojis: [
          ...
          "./assets/images/one/5.png",
          "./assets/images/one/6.png",
          "./assets/images/one/7.png",
          "./assets/images/one/8.png",
          "./assets/images/one/9.png",
          "./assets/images/one/10.png",
          "./assets/images/one/11.png",
          "./assets/images/one/12.png",
          "./assets/images/one/13.png",
          "./assets/images/one/14.png",
          "./assets/images/one/16.png",
          "./assets/images/one/15.png",
        ],
      },
      {
        ...
        emojis: [
          ...
          "./assets/images/two/5.png",
          "./assets/images/two/6.png",
          "./assets/images/two/7.png",
          "./assets/images/two/8.png",
          "./assets/images/two/9.png",
          "./assets/images/two/10.png",
          "./assets/images/two/11.png",
        ],
      },
      {
        ...
        emojis: [
          ...
          "./assets/images/three/5.png",
          "./assets/images/three/6.png",
          "./assets/images/three/7.png",
        ],
      },
    ],
